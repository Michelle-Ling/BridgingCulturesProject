...
const BgOverlay = styled.div`
  background: linear-gradient(32deg, #009EDC, #009EDC);
  opacity: 0.8;
  position: absolute;
  height: 100%;
  width: 100%;
  ...
  @media (min-width: 992px) {
    background-image: linear-gradient(62deg, #009EDC, #009EDC);
  }
`;
    ...
    <Section id="home">
      ...
      <div className="container">
        <HomeTitle data-aos="zoom-in">
          Get Connected to your Culture, Discover your Roots
        </HomeTitle>
        <SubTitle
          data-aos="fade-up"
